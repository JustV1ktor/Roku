            ...
            if responseCode = 200
                ...
                for each item in result
                    ...
                    if item.backdrop_path = invalid
                        itemcontent.HDPosterUrl = "https://image.tmdb.org/t/p/original" + item.poster_path
                    else 
                        itemcontent.HDPosterUrl = "https://image.tmdb.org/t/p/original" + item.backdrop_path
                    end if
